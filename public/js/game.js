var Game = function (settings, width, height) {
	...
	this.mainloop = function () {
		...
		message += ((this.keyboard.pressed(settings.Down)) ? 1 : 0);
		message += ((this.keyboard.pressed(settings.Left)) ? 1 : 0);
		message += ((this.keyboard.pressed(settings.Right)) ? 1 : 0);
		message += ((this.keyboard.pressed(settings.A)) ? 1 : 0);
		message += ((this.keyboard.pressed(settings.B)) ? 1 : 0);
		message += ((this.keyboard.pressed(settings.X)) ? 1 : 0);
